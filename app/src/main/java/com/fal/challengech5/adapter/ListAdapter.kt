package com.fal.challengech5.adapter
...
import com.fal.challengech5.databinding.ItemListBinding
import com.fal.challengech5.model.ResponseDataTaskItem

class ListAdapter(var itemTask : List<ResponseDataTaskItem>): RecyclerView.Adapter<ListAdapter.ViewHolder>() {
